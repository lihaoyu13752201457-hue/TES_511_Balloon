...
| 3 | v3p5 W2 | 6.325642e-05 | 4.7426 | v3p5_time_dependent_cumulative_interpolation |
| 4 | v3p5 broad 480-550 | 7.048891e-05 | 4.25599 | v3p5_time_dependent_cumulative_interpolation |
| 5 | DEMO2 legacy W2 spot_r90 | 8.748416e-05 | 3.42919 | legacy_pre_fix_documented_20d_Z_sqrt_exposure_scaling |
...
- CSV: `stepwise_maintenance/step08_significance/outputs/performance_curve_comparison_1Ms_fullstat_v2_exactpos/performance_curve_comparison_1Ms.csv`
- 511-CAM digitized CSV: `stepwise_maintenance/step08_significance/outputs/performance_curve_comparison_1Ms_fullstat_v2_exactpos/cam511_fig11_digitized_points.csv`
- figure: `stepwise_maintenance/step08_significance/outputs/performance_curve_comparison_1Ms_fullstat_v2_exactpos/performance_curve_comparison_1Ms.png`
- summary JSON: `stepwise_maintenance/step08_significance/outputs/performance_curve_comparison_1Ms_fullstat_v2_exactpos/performance_curve_comparison_1Ms_summary.json`

## Limitations

- v3p5 curves use the `fullstat_v2_exactpos` Step08 products available in this checkout.
