...
Base label: `fullstat_v2_exactpos_m50000_s260613`.
...
| --- | ---: | ---: | ---: | ---: |
| W2 hard window | 0.65203425 | 5.4028 | 5.96659 | 5.552672e-05 |
...
Feasibility: `EXACT_RPIP_POINTSOURCE_SMOKE_VALIDATED_AND_PROMOTED_TO_V3P5_RUN`. The exact-RPIP `PointSource` path is smoke-validated and this `fullstat_v2_exactpos_m50000_s260613` report is built from the summarized exact-position delayed transport. Source mode: `sampled_equal_flux_pointsource_blocks`, PointSource blocks: `50000`. Convergence status: `PASS_EXACTPOS_TRANSPORT_CONVERGENCE`.

## Outputs

- summary JSON: `outputs/reports/v3p5_boundary_closure_fullstat_v2_exactpos_m50000_s260613_20260613/v3p5_boundary_closure_summary.json`
- 45 deg curve CSV: `outputs/reports/v3p5_boundary_closure_fullstat_v2_exactpos_m50000_s260613_20260613/v3p5_45deg_los_time_curve.csv`
- annulus CSV: `outputs/reports/v3p5_boundary_closure_fullstat_v2_exactpos_m50000_s260613_20260613/v3p5_spatial_annular_likelihood.csv`
