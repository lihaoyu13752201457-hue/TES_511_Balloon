#!/usr/bin/env python3
"""Build a prompt Step05-like all-particle gross check for active-CsI collar."""
...
ALLPARTICLE_DIR = WORK / "runs/active_csi_collar_allparticle_smoke_g1m_r2_promptonly"
SUMMARY_JSON = WORK / "prompt511_active_csi_collar_allparticle_smoke_l1_proxy_summary.json"
SUMMARY_MD = WORK / "prompt511_active_csi_collar_allparticle_smoke_l1_proxy_summary.md"
...
def main() -> int:
    proxy = load_module("prompt511_repack_l1_proxy_base_active_csi_allparticle", BASE_PROXY)
    install_prompt_only_rate_fallback(proxy)
    step05 = load_module(
        "build_v3p5_centerfinger_step05_l1_response_active_csi_allparticle",
