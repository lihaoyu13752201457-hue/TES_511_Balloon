...
def build_source(triggers: int) -> dict[str, Any]:
    ...
    manifest = {
        ...
        "boundary": [
            ...
            "This low-stat source card is not a BGO rate authority by itself. Full-stat v2 exact-position delayed transport, Step05 detector response, Step06--Step08 mission-time significance, and the BGO-vs-CsI exact-position material-control comparison have since passed for the production bgo_sample_fullstat_v2_exactpos label.",
        ],
    }
