...
- The corresponding CsI exact-position M=50000 material-control comparison gives BGO `F3(20d)` lower by 4.730% and `Z20d` higher by 4.965%. This is the hard-window counting authority for this control branch.
