...
04 B-FULL Laue 光学 & 计算 511 keV 光学有效面积和聚焦焦面相空间 & \texttt{opticsim\_full}/B-FULL Ge(111) 模型，使用外部 XOP/CRYSTAL rocking curve；f10m A1 给出 $\aeff(511)=20.08476\,\mathrm{cm^2}$ 和 37,194 条 within-Be 焦面记录 & 只计算光学信号；未加入上游光学硬件 self-background \\
