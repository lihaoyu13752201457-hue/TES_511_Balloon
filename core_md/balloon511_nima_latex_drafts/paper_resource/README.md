...
- `table_simulation_workflow_en.tex`: English LaTeX table describing the layered simulation workflow and authority boundaries.
...
- `claude_r4_recheck_20260617.md`: Codex recheck of Claude R4 against the current M=50000 paper-facing authority and regenerated lightweight audits.
