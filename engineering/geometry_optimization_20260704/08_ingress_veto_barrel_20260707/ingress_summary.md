...
Atmospheric 511 ingress rows are extracted only for the 95 final W2 side_compton_fov_pass candidates listed in the P2 replay summary. The atmospheric raw/active/final veto cutflow is still the full P2 3M replay cutflow from `p2_geo_opt_s1_bpe_w5_atm511_transfer_summary.json`.
