...
Current S1 nominal 4pi ATM511-sidecar-included W2 performance is `4.62986036016e-05 ph cm^-2 s^-1`
at 20 days. At fixed signal acceptance, the requested `1.5e-5` requires total
background to fall from `0.0561719296626 cps` to `0.00589611677469 cps`,
an `89.50%` reduction.
...
- S1 nominal 4pi atmospheric 511 sidecar: `0.0207913135058 cps`
...
- Atmospheric 511 replay: `engineering/geometry_optimization_20260704/12_atm511_sidecar_replay_20260708/p2_geo_opt_s1_bpe_w5_atm511_sidecar_summary.json`
